! function (e, t) {
    ...
    var b = (I.prototype.next = function (t) {
        ...
        void 0 === (r = function (e, t) {
            ...
            for (var n = 0, r = t; n < r.length; n++) {
                var i = r[n];
                if (i in e && "function" == typeof e[i]) return true;
            }
            return false;
        ...
        var t = this;
        this.finalized || (this.finalized = true, void 0 !== e && (this.finalError = e), this.task.then(function () {
    ...
    function I(e, t) {
        var n = this;
        this.observers = [], this.unsubscribes = [], this.observerCount = 0, this.task = Promise.resolve(), this.finalized = false, this.onNoObservers = t, this.task.then(function () {
            e(n);
        }).catch(function (e) {
            n.error(e);
        });
    ...
    function $(e, t, n) {
        var r = this;
        this.firebase_ = n, this.isDeleted_ = false, this.name_ = t.name, this.automaticDataCollectionEnabled_ = t.automaticDataCollectionEnabled || false, this.options_ = h(void 0, e), this.container = new S(t.name), this._addComponent(new O("app", function () {
            return r;
    ...
    function Y(a) {
        var s = {},
            ...
            c = {
                ...
                initializeApp: function (e, t) {
                    ...
                    if (Object.prototype.hasOwnProperty.call(s, t)) throw V.create("duplicate-app", {
                        appName: t
                    });
                    n = new a(e, n, c);
                    return s[t] = n;
        ...
        function u(e) {
            if (!Object.prototype.hasOwnProperty.call(s, e = e || M)) throw V.create("no-app", {
                appName: e
            });
            return s[e];
        }
